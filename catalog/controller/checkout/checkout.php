...
////////do checkout
		if(($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->request->post['country_id'] = $this->config->get('config_country_id');	// :P dirty? 
			$this->request->post['postcode']='NO POSTCODE';// :P dirty?
			$this->request->post['zone_id']= $this->config->get('config_zone_id');// :P dirty?
...
////////language block
		...
		$this->document->addStyle('catalog/view/theme/bookstore/stylesheet/jquery.loadmask.css');
